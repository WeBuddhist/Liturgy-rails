...
python3 4-SYSTEM/scripts/stamp_metadata.py --ids --track-meta --titles --track "3-TRANSFORMATIONS/Translations/Gemini/ne"
```
...
| 2026-09-06 | Full corpus, `gm_corpus.py --lang` (model `gemini-3.1-pro-preview`, thinking default) | 94/94 texts, 1892/1892 blocks, 191 calls in the final resumed run, 0 line-parity failures, 0 failed blocks |
